...
<body>
    <div class="container">
        ...
        <div class="slider-container">
            ...
            <input id="repeat" type="range" min="0" max="100" value="50">
        </div>
        <div class="slider-container">
            <label for="uniformity">UNIFORMITY</label>
            <input id="uniformity" type="range" min="0" max="100" value="50">
        </div>
        <div class="slider-container">
        ...
        <div class="button-container">
            <button id="backButton" onclick="window.location.href = '/buttons'">BACK</button>
        </div>
    </div>
    <script>
        var sliders = {
